...
<center>
<br>
Descargue este reporte en formato estáfico PDF. [AQUÍ](https://github.com/LorenzoLeon/covid19_mex_Reportes/RedesSociales.pdf)
<br>
Descargue el archivo RMarkdown para crear este reporte aquí
[Rmarkdown](https://github.com/LorenzoLeon/covid19_mex_Reportes/RedesSociales.Rmd)
</center>
<br>
```
...
titulo <- "Frecuencia de tuits que mencionan al #COVID19mx"
subtitulo <- paste0("Tuits agrupados por hora del 15 de marzo al ", as.Date(max(tweets$fecha)))
...
***
```{block eval=FALSE, include=params$view_pdf}
Empezando con un diccionario de 50,000 palabras: donde hay algunas palabras (groserías, adjetivos fuertes) que asociamos con puntajes negativos; al mismo tiempo hay palabras positivas (cumplidos, buenos adjetivos) que nos permiten saber cuando, en un tweet alguien está hablando de manera negativa o positiva sobre un tema. Este sistema es automatizado y nos permite asignar un puntaje para cada palabra en los tweets de la base de datos, que nos permite saber el puntaje general por tweet. Con estos puntajes, sacamos un promedio de la puntuación de los tweets por hora, para así entender el sentimiento a lo largo del día. 
<br>
