...
<br>
```{r fig.width=9, echo =F, message=F, warning=F, fig.height=6, fig.align='center', fig.cap="Palabras más comunes en Tweets sobre COVID-19 en México - Twitter"}
...
Blah Blah
<br>
```{r fig.width=9, fig.height=6, fig.align='center', fig.cap="Hashtags más comunes en Tweets sobre COVID-19 en México - Twitter"}
hashtags <- tweets %>% 
...
htmlwidgets::saveWidget(WC_hashtags_twitter,"WC_hashtags_twitter.html",selfcontained = F)
WC_hashtags_twitter
```
...
BLahBLAH
<br>
```{r fig.width=9, fig.height=6, fig.align='center', fig.cap="Menciones más comunes en Tweets sobre COVID-19 en México - Twitter"}
...
htmlwidgets::saveWidget(WC_menciones_twitter, file = "WC_menciones_twitter.html",selfcontained = F)
