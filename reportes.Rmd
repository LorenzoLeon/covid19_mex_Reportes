...
titulo <- "Nivel de información respecto al COVID-19"
subtitulo <-"Resultados de distintas encuestadoras a nivel mundial" 
niv_con <- cuadros_OP %>% 
...
titulo <- "Evaluación del tratamiento mediático de la información sobre el COVID-19"
...
subtitulo <- "Resultados de distintas encuestadoras en México"
...
titulo <- "Aprobación del trabajo del Presidente en el manejo de la crisis derivada de la pandemia del COVID-19 (Internacional)"
subtitulo <- "Resultados de distintas encuestadoras a nivel mundial.
...
titulo <- "Aprobación del trabajo gubernamental local en el manejo de la crisis derivada de la pandemia del COVID-19"
subtitulo <- "Resultados de distintas encuestadoras a nivel mundial.
Sólo se muestran las proporciones de evaluaciones positivas."
...
titulo <- "Percepción de suficiencia en el manejo de la crisis derivada de la pandemia del COVID-19\n Gobiernos nacionales o federales"
subtitulo <- "Resultados de distintas encuestadoras a nivel mundial.
Sólo se muestran las proporciones de evaluaciones positivas."
...
titulo <- "Percepción respecto al impacto del COVID-19 en la vida personal y familiar"
subtitulo <- "Resultados de distintas encuestadoras a nivel mundial"
...
titulo <- "Percepción respecto al desarrollo de la pandemia del COVID-19"
subtitulo <- "Resultados de distintas encuestadoras a nivel mundial"
