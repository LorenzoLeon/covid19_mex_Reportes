...
filetoread = "covid_mex_20200329.xlsx"
```
```{r echo=F, background="white", message = FALSE, warning = FALSE}
#theme: cayman
...
ggsave("linea_tiempo.png", plot = ur2 + geom_label(aes(label = Casos))+ guides(label = FALSE), width = 15, height = 10, dpi = 100)

xfun::pkg_load2(c("base64enc", "htmltools", "mime"))
write_excel_csv(fig, "~/SynologyDrive/Drive/Code/Parametría/COVID_SEGUIMIENTO_MX/01_datos/Temps/Data_fecha_acumulada.csv")
```
<p>
```{r results='asis',echo=FALSE,message=FALSE}
xfun::embed_file('~/SynologyDrive/Drive/Code/Parametría/COVID_SEGUIMIENTO_MX/01_datos/Temps/Data_fecha_acumulada.csv', text = "Descargue los datos para la siguiente gráfica. AQUÍ")
```
<p>
...
plotly <- plotly::ggplotly(ur, tooltip = c("x", "y", "color"))%>%plotly::layout(tickvalues ="",annotations = 
...
htmlwidgets::saveWidget(plotly, file="linea_tiempo.html")
plotly
...
write_excel_csv(b,'~/SynologyDrive/Drive/Code/Parametría/COVID_SEGUIMIENTO_MX/01_datos/Temps/Data_sexo_edad.csv')
```
<p>
```{r results='asis',echo=FALSE,message=FALSE}
xfun::embed_file('~/SynologyDrive/Drive/Code/Parametría/COVID_SEGUIMIENTO_MX/01_datos/Temps/Data_sexo_edad.csv', text = "Descargue los datos para la siguiente gráfica. AQUÍ")
```
<p>
...
plotly <-  plotly::ggplotly(ur, tooltip = c("text"))%>%
 ...
 ggsave("Prop_sexo_edad.png", plot = ur + geom_label(na.rm = T, size = 5, aes(label = ifelse(abs(prop)<1,NA_character_,paste0(abs(round(prop,1)), "%")))), width = 15, height = 10, dpi = 100)
htmlwidgets::saveWidget(plotly, file="Prop_sexo_edad.html")
plotly
```
<p>
...
write_excel_csv(data_mapa,'~/SynologyDrive/Drive/Code/Parametría/COVID_SEGUIMIENTO_MX/01_datos/Temps/Datos_entidad_Acumulados_para_Mapa.csv')
```
<p>
```{r results='asis',echo=FALSE,message=FALSE}
xfun::embed_file('~/SynologyDrive/Drive/Code/Parametría/COVID_SEGUIMIENTO_MX/01_datos/Temps/Datos_entidad_Acumulados_para_Mapa.csv', text = "Descargue los datos para la siguiente gráfica. AQUÍ")
```
<p>
...
htmlwidgets::saveWidget(mymap, file="Mapa_Casos.html")
mymap
