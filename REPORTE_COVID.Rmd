...
plotly <- plotly::ggplotly(ur, 
  ...
  plotly::animation_slider(visible=F, active = length(unique(fig$Fecha)),
                           currentvalue = list(prefix = "YEAR ", 
                                               font = list(color="red")))

htmlwidgets::saveWidget(plotly, file="03_graficas/linea_tiempo.html")
plotly

```
[Link a esta gráfica](https://lorenzoleon.github.io/covid19_mex_Reportes/03_graficas/Linea_tiempo.html)
<p>
...
htmlwidgets::saveWidget(plotly, file="03_graficas/Prop_sexo_edad.html")
plotly
```
<p>
[Link a esta gráfica](https://lorenzoleon.github.io/covid19_mex_Reportes/03_graficas/Prop_sexo_edad.html)
<p>
...
htmlwidgets::saveWidget(mymap, file="03_graficas/Mapa_Casos.html")
mymap

```
<p>
[Link a este Mapa](https://lorenzoleon.github.io/covid19_mex_Reportes/03_graficas/Mapa_Casos.html)
<p>
