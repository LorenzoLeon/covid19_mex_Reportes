...
author: "[@lolo7no](https://twitter.com/lolo7no)"
date: "`r Sys.Date()`"
...
write_excel_csv(fig,'Temps/Datos_acumulados.csv')
```
<p>
```{r results='asis',echo=FALSE,message=FALSE}
xfun::embed_file('Temps/Datos_entidad_Acumulados_para_Mapa.csv', text = "Descargue los datos para la siguiente gráfica. AQUÍ")
```
<p>
...
write_excel_csv(b,'Temps/Data_sexo_edad.csv')
```
<p>
```{r results='asis',echo=FALSE,message=FALSE}
xfun::embed_file('Temps/Data_sexo_edad.csv', text = "Descargue los datos para la siguiente gráfica. AQUÍ")
```
<p>
...
estados_mexico <- readOGR(dsn = "~/SynologyDrive/Drive/Code/Parametría/COVID_SEGUIMIENTO_MX/01_datos/México_Estados/",verbose = F)
...
data_mapa <- data_fecha %>%
  ...
  select(-ends_with("NA"))%>%
  right_join(estados_mexico@data)
write_excel_csv(data_mapa,'Temps/Datos_entidad_Acumulados_para_Mapa.csv')
```
<p>
```{r results='asis',echo=FALSE,message=FALSE}
xfun::embed_file('Temps/Datos_entidad_Acumulados_para_Mapa.csv', text = "Descargue los datos para la siguiente gráfica. AQUÍ")
