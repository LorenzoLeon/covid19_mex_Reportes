...
<p>
Descargue los datos de este reporte desde el repositorio de [GITHUB](https://github.com/guzmart/covid19_mex)
<p>
Descargue el archivo RMarkdown para crear este reporte aquí
[Rmarkdown](https://lorenzoleon.github.io/covid19_mex_Reportes/HTML_REPORTE_COVID_REV_v2_light.Rmd)
<p>
...
ggsave("linea_tiempo.png", plot = ur + geom_label(aes(label = Casos)), width = 15, height = 10, dpi = 100)
